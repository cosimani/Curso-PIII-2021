...
- Punto de partida: El código del ejemplo anterior
- Reescribir el código para que en lugar de utilizar el Timer 1, se utilice el Timer 2.
- Y que la interrupción se dispare cada 5 segundos.
